    ...
    <div class="flex items-center gap-x-9 max-[1100px]:gap-x-6 max-lg:gap-x-8">
        ...
        <div class="flex justify-center w-full px-4 py-2">
            <form
                ...
                method="GET"
                role="search"
                class="flex items-center w-full max-w-[600px] rounded-md border border-gray-300 overflow-hidden bg-white1 shadow-sm">
                ...
                <input
                    ...
                    class="flex-grow search-box py-3 px-4 text-sm text-gray-800 placeholder-gray-400 focus:outline-none"
                ...
                <div class="flex items-center justify-center px-3 cursor-pointer border-r border-gray-200 bg-white h-9">
                ...
                <button
                    type="submit"
                    class="flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white text-sm font-semibold px-4 py-2 transition">
                    <img
                        src="{{ asset('themes/default/assets/images/search-icon.svg') }}"
                        alt="Search"
                        class="w-5 h-5" />
                    <span>Search</span>
                </button>
                    ...
                    <x-slot:content>
                        ...
                        <div class="mt-6 flex gap-4">
                            ...
                            <a
                                ...
                                class="secondary-button bg-blue m-0 mx-auto block w-max rounded-2xl border-2 px-7 text-center text-base max-md:rounded-lg max-md:py-3 ltr:ml-0 rtl:mr-0">
...
<script type="module">
    ...
    function updateAllPlaceholders(text) {
    ...
    function animatePlaceholders() {
        ...
        if (isTyping) {
            ...
            if (charIndex <= currentText.length) {
                updateAllPlaceholders(currentText.substring(0, charIndex));
                charIndex++;
                setTimeout(animatePlaceholders, 100);
            } else {
                isTyping = false;
                setTimeout(animatePlaceholders, 2000); // Pause at full text
            }
        } else {
            // Deleting backward
            if (charIndex >= 0) {
                updateAllPlaceholders(currentText.substring(0, charIndex));
                charIndex--;
                setTimeout(animatePlaceholders, 50); // Faster delete
            } else {
                isTyping = true;
                textIndex = (textIndex + 1) % placeholderTexts.length;
                setTimeout(animatePlaceholders, 300); // Pause before next
            }
        }
    }

    // Start animation when DOM is ready
    document.addEventListener('DOMContentLoaded', animatePlaceholders);
</script>
@endPushOnce
